...
public class SheepWoolUnderLayerMixin {
    ...
    private void wrapthatshi(Model model, ResourceLocation identifier, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, LivingEntityRenderState livingEntityRenderState, int i1, int i2, Operation<Void> original) {
