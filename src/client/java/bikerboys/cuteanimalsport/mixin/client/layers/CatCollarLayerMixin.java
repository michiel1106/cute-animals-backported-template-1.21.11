...
public abstract class CatCollarLayerMixin extends RenderLayer<CatRenderState, CatModel> {
    ...
    @Unique
    private static final ResourceLocation CAT_BABY_COLLAR_LOCATION = Constants.of("textures/entity/cat/cat_collar_baby.png");
    ...
    private void setCatBabyCollarLocation(Model model, ResourceLocation identifier, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, LivingEntityRenderState state, int i1, int i2, Operation<Void> original) {
        if (state.isBaby) {
