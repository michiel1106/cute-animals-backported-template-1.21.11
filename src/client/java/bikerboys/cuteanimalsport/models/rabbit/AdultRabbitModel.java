package bikerboys.cuteanimalsport.models.rabbit;


import bikerboys.cuteanimalsport.animation.*;
...
public class AdultRabbitModel extends AbstractRabbitModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                "right_haunch",
                CubeListBuilder.create().texOffs(20, 24).addBox(0F, 0.0F, 0F, 0F, 0F, 0F),
                PartPose.offsetAndRotation(0.0F, 0F, 0.0F, 0.0F, 0F, 0.0F)
        );

        root.addOrReplaceChild(
                "left_haunch",
                CubeListBuilder.create().texOffs(36, 24).addBox(0F, 0.0F, 0F, 0F, 0F, 0F),
                PartPose.offsetAndRotation(0.0F, 0F, 0.0F, 0.0F, 0F, 0.0F)
        );
